...
namespace GZBClient
{
    ...
    {
        private static UniversalFunctions _formBasicFeatrues = null;

        public static UniversalFunctions GetInstence()
        {
            if (_formBasicFeatrues == null)
            {
                _formBasicFeatrues = new UniversalFunctions();
            }
        ...
        public bool ifUpdateDatabasecheckLastModifiedTime(String remotePath, String localPath, bool isDownload)
        {
            HttpWebRequest gameFile = (HttpWebRequest)WebRequest.Create(remotePath);
            ...
            DateTime localFileModifiedTime = File.GetLastWriteTime(localPath);
        ...
        public List<String> FTPListFiles(String FTPUsername, String FTPPassword, String remoteFolder)
        {
        ...
        public Boolean FTPRenameRemoteFile(String FTPUsername, String FTPPassword, String path, String newFileName)
        {
